...
class jsonDataArg: _WrapArg, WrapArgProtocol {
    ...
    var python_function_arg: String { "\(_name): str" }
    ...
    var swift_callback_func_arg: String { "\(_name): Data" }
    
    var swift_callback_call_arg: String { "\(_name).jsonStr" }
...
//    var swift_property_setter: String { handleSendCallType2(T: _name)}
//
//    var swift_property_getter: String { handleCallbackCallType2(T: _name)}
