...
public class jsonDataArg: _WrapArg, WrapArgProtocol {
...
//    public var python_function_arg: String { "\(_name): str" }
//    
...
//    
//    public var swift_callback_func_arg: String { "\(_name): Data" }
//    
//    public var swift_callback_call_arg: String { "\(_name).jsonStr" }
//    
...
//    
////    public var swift_property_setter: String { handleSendCallType2(T: _name)}
////
////    public var swift_property_getter: String { handleCallbackCallType2(T: _name)}
//    
